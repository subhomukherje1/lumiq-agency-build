...
import birdseyeLogo from "@/assets/BirdseyePost-Logo.svg";
import camadaLogo from "@/assets/camada.svg";
import logo3 from "@/assets/logo-3.svg";

const clientLogos = [
  { src: aprilLogo, alt: "April", width: 100, height: 100 },
  { src: birdseyeLogo, alt: "Birdseye Post", width: 160, height: 160 },
  { src: camadaLogo, alt: "Camada", width: 160, height: 160 },
  { src: logo3, alt: "Client partner", width: 160, height: 160 },
];
...
const services = [
  {
    ...
    description:
      "We run LinkedIn ABM and high-intent Google Search campaigns optimized entirely for qualified pipeline — not clicks, not impressions, not vanity metrics.",
  ...
  },
  {
    ...
    description:
      "We use AI to find where your B2B buyers drop off and run rigorous A/B tests to convert more of your existing traffic into revenue — without increasing ad spend.",
    href: "/cro",
  },
  {
    icon: Database,
    ...
    description:
      "We fix your GA4, connect your CRM, and build executive dashboards that prove exactly which campaigns are generating closed revenue.",
    href: "/analytics",
  },
];
...
const aiTiles = [
  {
    ...
    description:
      "We use LLMs to generate A/B test ideas from your heatmaps, session recordings, and analytics data.",
  },
  {
    icon: Eye,
    title: "LLM Visibility Optimization",
    description:
      "We structure your content so your brand gets cited when buyers ask ChatGPT or Perplexity about your category.",
  },
  {
    icon: TrendingUp,
    title: "Predictive Attribution",
    description:
      "AI models that predict which campaigns will generate pipeline before you've spent the budget.",
  },
  {
    icon: Sparkles,
    title: "AI-Powered Personalisation",
    description:
      "Show different page variants to different buyer segments automatically, using behavioral signals.",
  },
];
...
const organizationSchema = {
  ...
  description:
    "AI-first B2B analytics, CRO, and performance marketing agency serving US and Canadian companies.",
  foundingDate: "2025",
  areaServed: ["US", "CA"],
  serviceType: [
  ...
  sameAs: ["https://linkedin.com/company/reviumlabs"],
};
  ...
  return (
    <>
      ...
      <section className="relative bg-dark min-h-screen flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-5 md:px-6 pt-12 md:pt-32 pb-16 md:pb-24 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Revium Labs is a B2B analytics, CRO, and performance marketing
              agency. We fix broken tracking, run AI-powered A/B tests, and turn
              your ad spend into provable pipeline.
            </motion.p>
            ...
            >
              Free audit delivered within 5 business days. No credit card
              required.
            </motion.p>

            <div className="container mx-auto px-5 md:px-6 mt-16">
              ...
              >
                <h2 className="font-display text-[26px] leading-tight md:text-4xl font-extrabold text-muted">
              ...
              <AnimatedSection delay={0.3}>
                <div className="flex flex-row justify-center items-center gap-16  ">
                  {clientLogos.map(({ src, alt, width, height }, i) => (
                    <div
                      key={i}
                      className="h-14 md:h-16  rounded-xl flex items-center justify-center"
                    >
                      <img
                        src={src}
                        alt={alt}
            ...
            {stats.map((stat, i) => (
              ...
              >
                <CountUp
                  ...
                  prefix={stat.prefix || ""}
                />
                <p className="mt-2 text-xs md:text-sm text-white/40 font-medium">
                  {stat.label}
                </p>
              </AnimatedSection>
            ))}
          ...
          <div className="max-w-3xl mx-auto text-left md:text-left">
            ...
            <AnimatedSection delay={0.2}>
              <p className="mt-6 md:mt-8 text-base md:text-lg text-muted-foreground leading-relaxed">
                Your GA4 is misconfigured. Your CRM has duplicate leads. Your
                attribution tells you LinkedIn works but cannot prove it closed
                a deal. So your marketing budget is a guess dressed up as a
                strategy.
              </p>
            </AnimatedSection>
            <AnimatedSection delay={0.3}>
              <p className="mt-4 md:mt-6 text-base md:text-lg text-foreground leading-relaxed font-medium">
                Revium Labs fixes the foundation, drives the right traffic, and
                uses AI to convert it — end to end.
              </p>
            </AnimatedSection>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
            {services.map((service, i) => (
              <AnimatedSection key={service.title} delay={i * 0.15}>
                <Link
                  to={service.href}
                  className="bg-dark rounded-2xl p-6 md:p-8 block h-full group hover-scale"
                >
                  ...
                  <p className="text-white/55 text-sm leading-relaxed mb-4 md:mb-6">
                    {service.description}
                  </p>
          ...
          <div className="max-w-3xl mx-auto text-center mb-10 md:mb-16">
            ...
            <AnimatedSection delay={0.2}>
              <p className="mt-4 md:mt-6 text-base md:text-lg text-white/45 leading-relaxed">
                Most agencies run the same playbook on every client. Revium Labs
                uses AI to analyze your funnel, generate test hypotheses,
                predict which experiments will move the needle, and surface
                attribution insights that manual analysis would take weeks to
                find.
              </p>
            </AnimatedSection>
          </div>
